...
export default function IntroText() {
  return (
    <div className="mx-auto">
      <div className="prose prose-sm prose-stone light:prose-invert dark:prose-dark max-w-none lg:leading-6 leading-relaxed">
        <p>
          ...
          development and AI - computational cognitive science to game design
