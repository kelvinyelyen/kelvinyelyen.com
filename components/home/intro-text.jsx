    ...
    <div className="mx-auto">
      <div className="prose prose-quoteless prose-stone prose-sm max-w-none dark:prose-invert lg:leading-6 leading-relaxed">
        <p>
          ...
          positive impact on the world. I'm constantly seeking to break barriers
          and explore novel approaches to problem-solving. My range of interests
          covers a broad spectrum, spanning from web development and
          computational cognitive science to game design and human-computer
          interaction.
        </p>
        <p>
          Outside of work, I'm deeply passionate about philosophy, neuroscience,
          travel, arts and culture etc. I enjoy engaging in philosophical and
          neuroscientific discussions, immersing myself in diverse art forms,
          and taking on creative projects. I believe that these experiences help
