...
const About = () => {
  return (
    <section className={`${styles.paddings} about relative z-10`}>
      <div className={`${styles.aboutWidth} mx-auto mt-[90px] lg:mt-[110px]`}>
        <p className="text-[10px] text-stone-500 lg:mx-[90px]">(ABOUT)</p>
        <p className="uppercase dark:font-light text-[12px] lg:text-base dark:text-stone-300 lg:mx-[90px] text-justify">
